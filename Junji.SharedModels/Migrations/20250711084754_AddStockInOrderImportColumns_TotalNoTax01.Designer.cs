...
namespace Junji.SharedModels.Migrations
{
    ...
    [Migration("20250711084754_AddStockInOrderImportColumns_TotalNoTax01")]
    partial class AddStockInOrderImportColumns_TotalNoTax01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.CompanyContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.CompanyDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.Inquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SummaryDeliveryDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SummaryRemark")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.PurchaseOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.StockInOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StockInOrders");
                });

            modelBuilder.Entity("Junji.SharedModels.Models.StockInOrderBarcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("StockInOrderDetailId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("StockInOrderDetailId");

                    b.ToTable("StockInOrderBarcodes");
                });

            modelBuilder.Entity("Junji.SharedModels.Models.StockInOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.CompanyContact", b =>
                {
                    b.HasOne("Junji.SharedModels.Models.Company", "Company")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.InquiryDetail", b =>
                {
                    b.HasOne("Junji.SharedModels.Models.Inquiry", "Inquiry")
                        .WithMany("Details")
                        .HasForeignKey("InquiryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Junji.SharedModels.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.PurchaseOrderDetail", b =>
                {
                    ...
                    b.HasOne("Junji.SharedModels.Models.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.StockInOrderBarcode", b =>
                {
                    b.HasOne("Junji.SharedModels.Models.StockInOrderDetail", "StockInOrderDetail")
                        .WithMany("Barcodes")
                        .HasForeignKey("StockInOrderDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StockInOrderDetail");
                });
            ...
            modelBuilder.Entity("Junji.SharedModels.Models.StockInOrderDetail", b =>
                {
                    ...
                    b.HasOne("Junji.SharedModels.Models.StockInOrder", "StockInOrder")
                        .WithMany("Details")
